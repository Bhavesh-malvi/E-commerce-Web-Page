        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 my-6 sm:my-8 md:my-10 gap-4 sm:gap-6 md:gap-7.5 px-3">
            ...
            <div className="md:col-span-2 rounded-[10px] bg-[url(https://codewithsadee.github.io/anon-ecommerce-website/assets/images/cta-banner.jpg)] bg-no-repeat bg-cover bg-center flex justify-center items-center min-h-64 sm:min-h-80 md:min-h-96">
                <div className="w-4/5 sm:w-3/5 md:w-1/2 h-[61%] bg-[rgba(255,255,255,0.6)] rounded-md flex flex-col justify-center items-center gap-2 sm:gap-3 py-6">
                    {activeMegaDeal ? (
                        <>
                            <p className='uppercase border px-2 py-1 text-sm sm:text-base md:text-[17px] font-semibold text-white bg-[#212121] rounded-[5px]'>
                                {activeMegaDeal.discountPercentage}% Discount
                            </p>
                            <p className='text-xl sm:text-2xl md:text-[28px] text-[#454545] font-bold w-[90%] sm:w-[80%] md:w-[70%] text-center uppercase'>
                                {activeMegaDeal.title}
                            </p>
                            {/* "Starting @ $10" removed as requested */}
                            <p 
                                className='uppercase text-sm sm:text-base md:text-[18px] font-bold text-[#787878] mt-1 sm:mt-2 cursor-pointer hover:text-[#FF8F9C] transition-colors'
                                onClick={() => navigate('/hotOffer')}
                            >
                                shop now
                            </p>
                        </>
